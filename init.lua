...
require('lazy').setup({
  ...
  --       vim.keymap.set('n', '<leader>hp', require('gitsigns').preview_hunk, { buffer = bufnr, desc = '[P]review git hunk' })
  --
  ...
  -- require 'amautave.config',
  
  -- NOTE: The import below can automatically add your own plugins, configuration, etc from `lua/amautave/plugins/*.lua`
